...
![Tools](https://skillicons.dev/icons?i=next,flutter,dart,go,html,css,c,python,cpp,rust,blender,github,tensorflow,git,aws,javascript,react,linux,bash,gcp,flask,django,docker,java,mysql,nodejs,mongo,matlab,pytorch,sqlite,electron,ts,mostache,redis,vue,angular,nuxt,svelte,fastapi,arduino,raspberrypi,esp32,esp8266,stm32,ue5,unity,solidity,swift,kotlin,kubernetes,firebase,tailwind,postgresql,graphql,php,tauri,xcode,androidstudio,angularjs,jquery,nginx,terraform,threejs,express,vite,ros,opencv,postman,notion,figma,vscode&theme=dark)
